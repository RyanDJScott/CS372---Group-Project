                            ...
                            <table id="members-landing-card">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="projectMember1Task1" class="text-input" value="<?php echo htmlspecialchars($tasks[0]); ?>"/></td>
                                        <td><input type="date" name="projectMember1DeadlineTask1" value="<?php echo htmlspecialchars($deadlines[0]); ?>"/></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="projectMember1Task2" class="text-input" value="<?php echo htmlspecialchars($tasks[1]); ?>" /></td>
                                        <td><input type="date" name="projectMember1DeadlineTask2" value="<?php echo htmlspecialchars($deadlines[1]); ?>" /></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="projectMember2Task1" class="text-input" value="<?php echo htmlspecialchars($tasks[2]); ?>" /></td>
                                        <td><input type="date" name="projectMember2DeadlineTask1" value="<?php echo htmlspecialchars($deadlines[2]); ?>" /></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="projectMember2Task2" class="text-input" value="<?php echo htmlspecialchars($tasks[3]); ?>" /></td>
                                        <td><input type="date" name="projectMember2DeadlineTask2" value="<?php echo htmlspecialchars($deadlines[3]); ?>" /></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="projectMember3Task1" class="text-input" value="<?php echo htmlspecialchars($tasks[4]); ?>" /></td>
                                        <td><input type="date" name="projectMember3DeadlineTask1" value="<?php echo htmlspecialchars($deadlines[4]); ?>" /></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="projectMember3Task2" class="text-input" value="<?php echo htmlspecialchars($tasks[5]); ?>" /></td>
                                        <td><input type="date" name="projectMember3DeadlineTask2" value="<?php echo htmlspecialchars($deadlines[5]); ?>" /></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="projectMember4Task1" class="text-input" value="<?php echo htmlspecialchars($tasks[6]); ?>" /></td>
                                        <td><input type="date" name="projectMember4DeadlineTask1" value="<?php echo htmlspecialchars($deadlines[6]); ?>" /></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="projectMember4Task2" class="text-input" value="<?php echo htmlspecialchars($tasks[7]); ?>" /></td>
                                        <td><input type="date" name="projectMember4DeadlineTask2" value="<?php echo htmlspecialchars($deadlines[7]); ?>" /></td>
                                    </tr>
