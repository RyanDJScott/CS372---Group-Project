                ...
                <article>
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST" enctype="multipart/form-data" id="submitForm">
                        <div>
                            <table>
                                <tr>
                                    <td>Profile Picture: </td><td> <input type="file" name="profilePicture" id="profilePicture" class="custom-file-input" enctype="multipart/form-data"/></td><td>Bio: </td><td> <textarea name="bio" id="employeeBio" cols="30" rows="10"><?php echo htmlspecialchars($ProfileBio); ?></textarea></td>
                                </tr> 
